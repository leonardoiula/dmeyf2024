...
TS_strategy_base6 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202103, 202102,
...
wf_expcol_grupob_wevn_789101_v2 <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea workflow inicial fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/competencia_02_sin_baja.csv.gz")
...
wf_expcol_grupob_wevn_789101_v2()
#en esta version no incluyo el 202104
